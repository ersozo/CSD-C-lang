...
- _Fonksiyonel Diller (Functional Languages)_: Bıunlar adeta formül yazar gibi program yazmaya olanak sağlayan dillerdir. Aslında kendi aralarında bir spektrum
...
int main(void)
{
foo(); /_ foo çağrıldı ancak geri dönüş değeri kullanılmadı, tamamen geçerli _/
...
{
for (int i = 0; i < 10; ++i)
for (int i = 0; i < 10; ++i) /_ geçerli ama kötü teknik _/
putchar('.');
...
int main(void)
{
	char s[] = "ankara";        /* dikkat, editörünüz Türkçe karakterleri UTF-8 olarak iki byte halinde kodluyor olabilir */
	size_t result;
...
int main(void)
{
	char s[] = "ağrı";          /* dikkat, editörünüz Türkçe karakterleri UTF-8 olarak iki byte halinde kodluyor olabilir */
	size_t result;
